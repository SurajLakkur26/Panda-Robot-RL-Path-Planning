...
This repository contains a modular Python implementation of a **robotic path planning and collision avoidance task** using **Reinforcement Learning (RL)**. The project leverages a high-fidelity robot simulation environment to train a **7-DOF Franka Emika Panda arm** to navigate to randomized goal positions while avoiding dynamic and static obstacles.
